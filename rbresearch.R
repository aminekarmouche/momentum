...
#############################################################################
######################################Second page
#comparing lookbackperiods and the ranking factors (top 1 4 or 8 assets)
...
currency("USD")
symbols <- c("VFISX", "S&P 500","XLY", "XLP", "XLE", "XLF", "XLV", "XLI", "XLK", "XLB", "XLU", "EFA")#, "TLT", "IEF", "SHY")
...
getSymbols(symbols, from="1997-12-31", to="2015-02-18", env = symEnv)
